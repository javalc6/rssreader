...
//                            {"ARD Radio Tatort", "https://web.ard.de/radiotatort/rss/podcast.xml", "e660.de"},
                            ...
                            {"Graphitti-Blog", "https://www.graphitti-blog.de/feed/", "e663.de"},
                            {"heute-show", "https://www.zdf.de/rss/zdf/comedy/heute-show", "e664.de"},
                            {"Hornoxe.com", "https://www.hornoxe.com/feed/", "e665.de"},
                            {"ibash.de - Neueste Zitate", "https://www.ibash.de/neueste-zitate.xml", "e666.de"},
                            ...
                            {"Schlecky Silberstein", "https://www.schleckysilberstein.com/feed/", "e671.de"},
...
//                            {"Dandy Diary", "https://dandydiary.de/feed/", "f680.de"},
                    ...
                    {//m
                            {"Blogrebellen", "https://blog.rebellen.info/feed/", "m688.de"},
...
//                            {"Spex Magazin", "https://www.spex.de/feed/", "m700.de"},
                    ...
                    {//n
                            ...
                            {"DW.de - News", "https://partner.dw-world.de/syndication/feeds/RSS_deu_Feedly_News.10729-mrss.xml", "n708.de"},
                    ...
                    {//s
                            ...
                            {"SciLogs", "https://www.scilogs.de/wblogs/feed/rss.php", "s746.de"},
...
//                            {"ELLE.ru", "https://www.elle.ru/rss/elle_ru/rss.xml", "f813.ru"},
                            ...
                            {"ШмотоМодо.Ру — мода, шмотки, тенденции", "https://shmotomodo.ru/feed", "f830.ru"},
                    },
                    {//l
                            ...
                            {"Блог о здоровом  образе жизни", "https://zdoro.ru/feed", "l834.ru"},
                    ...
                    {//m
                            ...
                            {"Погружение в классику", "https://intoclassics.net/news/rss/", "m863.ru"},
                    ...
                    {//n
                            ...
                            {"Все материалы Republic", "https://slon.ru/rss/all.php", "n873.ru"},
...
//                            {"Newtonew: новости образования и современные образовательные технологии", "https://newtonew.com/rss/", "s907.ru"},
                            ...
                            {"Новости HPC.ru: КПК и коммуникаторы", "https://www.hpc.ru/exp/hpcru_news.rss", "s912.ru"},
                    ...
                    {//o
                            ...
                            {"FAPL.ru", "https://fapl.ru/rss.xml", "o917.ru"},
                            {"Sportbox.ru - Главные новости", "https://news.sportbox.ru/taxonomy/term/7212/0/feed", "o918.ru"},
...
//                            {"Trivela", "https://trivela.uol.com.br/feed/", "o645.pt"},
            ...
            {//en
                    {//b
                            ...
                            {"Harvard Business Review ", "https://feeds.harvardbusiness.org/harvardbusiness/", "b85.en"},
                    ...
                    {//e
                            {"E! Online", "https://feeds.eonline.com/eonline/uk/topstories", "e6.en"},
...
//                            {"TV Guide", "https://rss.tvguide.com/breakingnews", "e8.en"},
                    ...
                    {//f
                            ...
                            {"Everyday Carry", "https://everyday-carry.com/rss", "f109.en"},
                            {"Fashion Squad", "https://www.fashionsquad.com/feed/", "f110.en"},
                            {"From Me To You", "https://annstreetstudio.com/feed/", "f111.en"},
...
//                            {"Huffington Post", "https://www.huffingtonpost.com/section/style/feed", "l79.en"},
                            {"Everyday Carry", "https://everyday-carry.com/rss", "l118.en"},
                    ...
                    {//n
                            ...
                            {"CNN Top Stories", "https://rss.cnn.com/rss/cnn_topstories.rss", "n34.en"},
                            {"CNN Europe", "https://rss.cnn.com/rss/edition_europe.rss", "n35.en"},
                            ...
                            {"BBC", "https://newsrss.bbc.co.uk/rss/newsonline_world_edition/front_page/rss.xml", "n143.en"},
                    ...
                    {//s
                            ...
                            {"PhysOrg.com", "https://www.physorg.com/rss-feed/", "s51.en"},
                            ...
                            {"BBC News - Science & Environment", "https://newsrss.bbc.co.uk/rss/newsonline_world_edition/science/nature/rss.xml", "s169.en"},
                    ...
                    {//o
                            ...
                            {"BBC Sport - Football", "https://newsrss.bbc.co.uk/rss/sportonline_uk_edition/football/rss.xml", "o183.en"},
                            {"BBC Sport - Formula 1", "https://newsrss.bbc.co.uk/rss/sportonline_world_edition/motorsport/formula_one/rss.xml", "o184.en"},
                            {"BBC Sport - Sport", "https://newsrss.bbc.co.uk/rss/sportonline_world_edition/front_page/rss.xml", "o185.en"},
                    ...
                    {//t
                            ...
                            {"The Loop", "https://feeds.loopinsight.com/loopinsight/KqJb", "t74.en"},
...
//                            {"Downloadblog.it", "https://www.downloadblog.it/rss2.xml", "t323.it"},
            ...
            {//fr
                    ...
                    {//f
                            ...
                            {"Miss Pandora", "https://www.misspandora.fr/feed/", "f482.fr"},
                    ...
                    {//l
                            ...
                            {"Miss Pandora", "https://www.misspandora.fr/feed/", "l496.fr"},
...
//                            {"Le Grand Jury", "https://podcast.rtl.fr/grandjury.xml", "p528.fr"},
                    ...
                    {//o
                            ...
                            {"Sport24", "https://www.sport24.com/rssfeeds/sport24-accueil.xml", "o543.fr"},
                            {"Sport24 - Auto", "https://www.sport24.com/rssfeeds/sport24-formule1.xml", "o544.fr"},
                            {"Sport24 - Auto/Moto", "https://www.sport24.com/rssfeeds/sport24-moto.xml", "o545.fr"},
                            {"Sport24 - Cyclisme", "https://www.sport24.com/rssfeeds/sport24-cyclisme.xml", "o546.fr"},
            ...
            {//es
                    ...
                    {//f
                            {"A TRENDY LIFE", "https://www.atrendylifestyle.com/feeds/posts/default", "f359.es"},
                            ...
                            {"Nosotras", "https://www.nosotras.com/rss.asp", "f368.es"},
...
//                            {"Esquire", "https://editorial.esmas.com/rss/esquire/", "l374.es"},
                    ...
                    {//n
                            ...
                            {"DW.de - Noticias", "https://partner.dw-world.de/syndication/feeds/RSS_sp_Feedly_News.10727-mrss.xml", "n399.es"},
                    ...
                    {//p
                            ...
                            {"Guerra Eterna", "https://www.guerraeterna.com/atom.xml", "p416.es"},
...
//                            {"La pizarra de Yuri", "https://www.lapizarradeyuri.com/feed/", "s428.es"},
                            ...
                            {"Tendencias 21", "https://www.tendencias21.net/xml/syndication.rss", "s435.es"},
...
//                            {"El Informador :: Noticias de Jalisco, México, Deportes & Entretenimiento", "https://rss.informador.com.mx/informador-ultimas-noticias?format=xml", "o440.es"},
                            ...
                            {"F1 al día", "https://feeds.noxvo.com/f1aldia/", "o442.es"},
                            ...
                            {"Transformer", "https://transformer.blogs.quo.es/feed/", "o447.es"},
